...
def _fused_append_shared_experts_kernel(
    ...
    # tl.arange requires a power-of-2 length; K/S (routed top-k / shared count)
    # are not necessarily powers of 2 (e.g. MiniMax-M3: K=4 routed, S=1 shared),
    # so iterate over the next power of 2 and mask the tail.
